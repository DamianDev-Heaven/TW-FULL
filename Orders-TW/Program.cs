...
builder.Services.AddCors(options =>
{
    ...
    {
        // PRODUCCI�N: Cambiar AllowAnyOrigin por or�genes espec�ficos
...
if (string.IsNullOrEmpty(secretKey) || secretKey.Length < 32)
{
    throw new InvalidOperationException(
        ...
        "Para desarrollo, est� en appsettings.json. Para producci�n, usar variables de entorno o Azure Key Vault.");
}
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1.0",
        Description = "API REST profesional para gestionar sistema de �rdenes de compra"
    });
...
builder.Services.AddDbContext<AppDbContext>(options =>
{
    ...
    {
        throw new InvalidOperationException(
            "No se encontr� la cadena de conexion 'DefaultConnection'. " +
            "Config�rala usando User Secrets: dotnet user-secrets set \"ConnectionStrings:DefaultConnection\" \"tu_cadena_aqui\"");
    }
